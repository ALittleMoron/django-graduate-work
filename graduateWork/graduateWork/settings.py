...
PATH_TO_BIBLIOFUND = os.path.join(BASE_DIR, 'applications', 'bibliofund')
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'graduateWork', 'templates'),
            os.path.join(PATH_TO_BIBLIOFUND, 'templates'),
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'graduateWork', 'static')
]
